...
/*
	...
	$Id: admincp_sitefeed.php 11954 2009-04-17 09:29:53Z liguode $
*/
...
if(submitcheck('feedsubmit')) {
	...
	if(empty($feedid)) {
		...
		//更新热度
		updatetable('feed', array('hot' => intval($_POST['hot'])), array('feedid'=>$feedid));
...
if($_GET['op'] == 'add') {
	...
	if($count) {
		...
		$multi = multi($count, $perpage, $page, 'admincp.php?ac=sitefeed');
	}
}
