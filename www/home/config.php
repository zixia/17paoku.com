...
//Ucenter Home配置参数
$_SC = array();
$_SC['dbhost']  		= getenv('PAOKU17_MYSQL_HOST'); //服务器地址
$_SC['dbuser']  		= getenv('PAOKU17_MYSQL_USER'); //用户
$_SC['dbpw'] 	 		= getenv('PAOKU17_MYSQL_PASS'); //密码
$_SC['dbname']  		= '17paoku'; //数据库
...
define('UC_DBHOST', getenv('PAOKU17_MYSQL_HOST')); // UCenter 数据库主机
define('UC_DBUSER', getenv('PAOKU17_MYSQL_USER')); // UCenter 数据库用户名
define('UC_DBPW', getenv('PAOKU17_MYSQL_PASS')); // UCenter 数据库密码
define('UC_DBNAME', '17paoku'); // UCenter 数据库名称

define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`17paoku`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', '46E229h9762fu4deK3g6d9N7hcd758N1b608R558Xcu7zcxcmf313a77P762a63a'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'https://17paoku.zixia.net/center'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
define('UC_CHARSET', 'utf-8'); // UCenter 的字符集
define('UC_IP', '211.99.222.64'); // UCenter 的 IP, 当 UC_CONNECT 为非 mysql 方式时, 并且当前应用服务器解析域名有问题时, 请设置此值
